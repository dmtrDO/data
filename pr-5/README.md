## 4. Обробка та злиття даних з різних джерел:<br>Реалізувати обробку даних з CSV, JSON та SQL, їх очищення та злиття в один датафрейм
...
- **JSON** - отримано через [Open-Meteo API](https://open-meteo.com/). Тут є щоденні показники опадів та максимальної швидкості вітру. Доступ до даних по конкретному [API](https://archive-api.open-meteo.com/v1/archive?latitude=50.4547&longitude=30.5238&start_date=1980-04-05&end_date=2026-04-19&daily=precipitation_sum,wind_speed_10m_max&timezone=auto&wind_speed_unit=ms);
