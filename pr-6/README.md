...
## Експеримент
<p align="justify">
Було обрано застосунок <span style="color:red">phyphox</span> (перший зі списку, запропонований у роботі), оскільки інші, такі як sensors kinetics (рисунок 1) чи arduino science journal (рисунок 2) не надавали значень орієнтації. </p><br><br>
